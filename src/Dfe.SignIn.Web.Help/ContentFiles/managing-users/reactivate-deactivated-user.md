...
title: Reactivate deactivated user accounts
summary: |
...
For security reasons, all DfE Sign-In accounts are deactivated after 2 years of inactivity.

Accounts may also be deactivated if the email address doesn’t comply with the service [terms and conditions](/terms).
