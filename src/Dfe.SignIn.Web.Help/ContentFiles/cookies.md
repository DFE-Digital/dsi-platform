...
| **dsi-correlation-id-{unique-value}** | Keeps track of your login process safely                                           | 15 minutes after issuance            |
| **dsi-nonce-{unique-value}**          | Protections against replay attacks                                                 | 15 minutes after issuance            |
| **dsi-antiforgery**                   | Protection against cross-site request forgery                                      | When the browser is closed           |
| **dsi-auth**                          | The DfE Sign-in session needed to identify the user to the services                | When the browser is closed           |
| **dsi-temp-data**                     | Storage of temporary non sensitive data between requests                           | When the browser is closed           |
| **dsi-external-auth**                 | Temp cookie storing external-provider identity state                               | 20 minutes after issuance            |
