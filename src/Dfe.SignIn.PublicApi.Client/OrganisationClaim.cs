...
/// <summary>
/// Represents the organisation claim of a user.
/// </summary>
/// <remarks>
///   <para>The level of detail present depends upon what was requested when the
///   user was prompted to select an organisation.</para>
/// </remarks>
public sealed record OrganisationClaim()
{
    /// <summary>
    ...
    // TODO: Add missing properties... (note, all properties are nullable)
