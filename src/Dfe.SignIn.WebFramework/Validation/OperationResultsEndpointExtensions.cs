...
/// <summary>
/// Provides extension methods for converting <see cref="OperationResult"/> and <see cref="OperationError"/> instances to validation problem results.
/// </summary>
public static class OperationResultsEndpointExtensions
{
    /// <summary>
    /// Converts an <see cref="OperationError"/> instance to a validation problem result.
    /// </summary>
    ...
    public static IResult ToValidationProblem(this OperationError error, string? propertyName = null, string? type = null)
    {
    ...
    /// <summary>
    /// Converts a <see cref="OperationResult"/> instance to a validation problem result.
    /// </summary>
    ...
    public static IResult ToValidationProblem(this OperationResult result, string? propertyName = null, string? type = null)
    {
        if (result.IsSuccess) {
