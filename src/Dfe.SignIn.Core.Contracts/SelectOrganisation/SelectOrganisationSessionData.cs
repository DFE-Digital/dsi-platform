...
{
    /// <summary>
    /// The date/time that the session was created.
    /// </summary>
    public required DateTime Created { get; init; }

    /// <summary>
    /// The date/time that the session expires.
    /// </summary>
    public required DateTime Expires { get; init; }

    /// <summary>
    /// The unique client ID of the relying party that initiated the
    /// "select organisation" request on behalf of the user.
    /// </summary>
    public required string ClientId { get; init; }

    /// <summary>
    /// The unique identifier representing the user in DfE Sign-in.
    /// </summary>
    public required Guid UserId { get; init; }

    /// <summary>
    /// The prompt that will be presented to the user when they are selecting
    /// an organisation.
    /// </summary>
    public required SelectOrganisationPrompt Prompt { get; init; }

    /// <summary>
    /// The enumerable collection of organisations that will be presented
    ...
    /// <summary>
    /// The callback URL which is invoked when the user makes a selection; when there
    /// is no selection to be made; or when an error has occurred.
    /// </summary>
