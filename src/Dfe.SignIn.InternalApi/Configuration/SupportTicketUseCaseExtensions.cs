...
/// <summary>
/// Extension methods for setting up "Support Ticket" use cases.
/// </summary>
public static class SupportTicketUseCaseExtensions
{
    /// <summary>
    ...
    /// </exception>
    public static IServiceCollection AddSupportTicketUseCases(
        this IServiceCollection services, IConfigurationRoot configuration)
    {
        ExceptionHelpers.ThrowIfArgumentNull(services, nameof(services));
        ExceptionHelpers.ThrowIfArgumentNull(configuration, nameof(configuration));

        services.AddInteractor<GetApplicationNamesForSupportTicketUseCase>();
        return services;
    }
}
