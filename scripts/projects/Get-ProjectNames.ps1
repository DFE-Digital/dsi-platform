...
#>
    ...
    [String[]]$sourceProjects = Get-ChildItem -Directory "$Path/src" | Select-Object -ExpandProperty Name | Sort-Object
    [String[]]$testProjects = Get-ChildItem -Directory "$Path/tests" | Select-Object -ExpandProperty Name | Sort-Object
